...
void tone( int melody, int duration ) {
    ...
    if (melody == 0) {
       ...
       period = 200000 / melody;    // 19.2 MHz / 96 = 200 KHz
       pwmSetRange( period );
...
int tongsong(void)
{
    ...
    for (i = 0; i < 48; i++) {
       noteDuration = 1800000 / noteDurations[i];
...
int servo( void )
{
    ...
    pwmSetRange( 4000 );
    pwmWrite( servopin, 340 );   // min 175 = 0 degree, max 505 = 180 degree
    printf("90 degree\n");
    delay( 1000 );

    for ( i=0; i<3; i++ )
    {
        pwmWrite( servopin, 175);
        printf("0 degree\n");
        delay( 1000 );
        pwmWrite( servopin, 340);
        printf("90 degree\n");
        delay( 1000 );
        pwmWrite( servopin, 505);
        printf("180 degree\n");
        delay( 1000 );
        pwmWrite( servopin, 340);
        printf("90 degree\n");
